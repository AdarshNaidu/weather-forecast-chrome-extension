const key = "54b0c10571a1c21955309ef23d191ea5";
...
let weather = {
  ...
  displayWeather : function(n){
    let content;
    if(n==0){
      content = "Today It's " + this.description + " in "+ this.name + " at "+ this.temperature + "°C "+ "and "+ this.humidity+"% Humidity" ;
    }else{
     content = "Day "+n+" :- It will be " + this.description + " in "+ this.name + " at "+ this.temperature + "°C "+ "and "+ this.humidity+"% Humidity" ;
    }
